...
const ChatSidebar = ({
  ...
  // search box only filters the "new chat" user list, kept local to the sidebar
  const [searchQuery, setSearchQuery] = useState("");

  return (
    // on mobile the sidebar is fixed and slides in/out, on sm+ it is always visible
    <aside
    ...
    >
      ...
      <div className="p-6 border-b border-gray-700">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* toggles between the chat list and the all users list */}
          <button
        ...
        {showAllUsers ? (
          <div className="space-y-4 h-full">
            ...
            <div className="space-y-2 overflow-y-auto h-full pb-4">
              {users
                // never show yourself, and honour the search box
                ?.filter(
                  (u) =>
                ...
                .map((u) => (
                  // clicking a user creates the chat (or opens the existing one)
                  <button
                    key={u._id}
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        ...
                        {/* green dot comes from the socket online users list */}
          ...
          <div className="space-y-2 overflow-y-auto h-full pb-4">
            {chats.map((chat) => {
              ...
              // decides which arrow icon to show next to the preview text
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    // auto close the drawer on mobile after picking a chat
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      {/* online dot for the other person in this chat */}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {/* unread badge, capped so the layout never breaks */}
                        {unseenCount > 0 && (
          ...
          // empty state when the user has no chats at all
